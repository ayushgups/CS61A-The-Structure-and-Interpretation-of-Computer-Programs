def berry_finder(t):
    ...
    if label(t) == 'berry':
        ...
        if True in [berry_finder(branches(t)[i]) for i in range(len(branches(t)))]:
            return True 
    return False
...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t) and label(t) == "loki":
        new_tree = new_tree + tree(lokis_replacement)
    else:
        new_tree = new_tree + tree(label(t))
        return new_tree + [replace_loki_at_leaf(branches(t)[i], lokis_replacement) for i in range(len(branches(t)))]
...
def closer_city(lat, lon, city_a, city_b):
    ...
    a_minus_c = distance(city_a, city_c)
    b_minus_c = distance(city_b, city_c)
    if a_minus_c < b_minus_c:
